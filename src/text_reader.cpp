...
void TextReader::begin(const String& fname) {
    filename = fname;
    currentPage = 0;
    refreshCounter = 0;
    exitRequested = false;
...
void TextReader::parseIntoPages() {
    pages.clear();
...
void TextReader::drawNavigation() {
...
void TextReader::update() {
    handleTouch();
}

void TextReader::handleTouch() {
